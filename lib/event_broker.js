...
var EventBroker = {
  ...
  send: function (ev, callback) {
    logger.info({eventId:ev.messageId,applicationId:ev.applicationId},'sending event');
  ...
  publish: function (ev, callback) {
    logger.info({eventId:ev.messageId,applicationId:ev.applicationId},'publishing event');
  ...
  process: function (ev) {
    logger.info({event:ev},'processing event');
